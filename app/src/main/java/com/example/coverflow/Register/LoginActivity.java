...
public class LoginActivity extends AppCompatActivity {
    ...
    public void login(View v) {
        ...
        try {
            ...
            if (rs.equals("yes"))
                Toast.makeText(LoginActivity.this, "LOGIN SUCCESSFUL" + rs, Toast.LENGTH_LONG).show();
            else
                Toast.makeText(LoginActivity.this, "LOGIN UNSUCCESSFUL" + rs, Toast.LENGTH_LONG).show();
            finish();
